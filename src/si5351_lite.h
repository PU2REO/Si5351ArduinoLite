/*
 * si5351_lite.h - Si5351 library for Arduino
 *
...
#ifndef SI5351_LITE_H_
#define SI5351_LITE_H_
...
#define SI5351_PLL_FIXED                70000000000ULL
...
private:
  ...
  bool clk_first_set[SI5351_CLK_MAX];
};
